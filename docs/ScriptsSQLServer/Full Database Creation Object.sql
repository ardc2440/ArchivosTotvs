...
(
	ERP_SHIPPING_PROCESS_ID INT NOT NULL CONSTRAINT PK_ERP_SHIPPING_PROCESS PRIMARY KEY,
...
(
	ERP_SHIPPING_PROCESS_DETAIL_ID INT NOT NULL CONSTRAINT PK_ERP_SHIPPING_PROCESS_DETAIL PRIMARY KEY,
	ERP_SHIPPING_PROCESS_ID INT NOT NULL CONSTRAINT FK_ERPShippingProcess REFERENCES ERP_SHIPPING_PROCESS (ERP_SHIPPING_PROCESS_ID),
	DOCUMENT_TYPE_ID SMALLINT NOT NULL CONSTRAINT FK_ERPDocumentType REFERENCES DOCUMENT_TYPES (DOCUMENT_TYPE_ID),
...
SELECT IDPEDIDO SALEID, ACTIONTYPE, FECHACREACION ACTIONDATE 
  FROM (
        ...
        UNION 
        SELECT 'X', C.CUSTOMER_ORDER_ID IDPEDIDO, CAST(MAX(C.CANCELLATION_DATE) AS TIMESTAMP)
          FROM CANCELED_CUSTOME_ORDERS C
